...
CHOICES = [
	...
	"Vi rintanate in Taverna", '"Urra, una vera Impresa!"', "...iniziate a ragionare sui primi craft.", "Vi barricate nella stanza.", '"Avrà qualche cosa da dire..."', # formiche, forse scelte sbagliate
]
